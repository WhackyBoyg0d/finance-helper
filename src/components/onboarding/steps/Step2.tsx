...
function Step2({ userData, handleInputChange, prevStep, handleSubmit }: Props) {
    return (
        <div className=" rounded-md px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-4">
                    <h2 className="mb-4 ">Whats your monthly income? <span data-tooltip-id="my-tooltip"
  data-tooltip-content="This allows us to personalise your investing and saving goals!"
  data-tooltip-place="top" className='text-xs text-slate-50 bg-slate-500 rounded-full px-1.5 py-1 '>?</span></h2>
                    <input
